...
1. **Backend**
   - Deploy the backend (e.g. on Render) and set:
     - `ALLOWED_ORIGINS` to your Vercel URL, e.g. `https://your-app.vercel.app`.
     - **`OAUTH_SUCCESS_REDIRECT`** to your app’s linked page so sign-in redirects to the web app: `https://your-app.vercel.app/linked.html`.
